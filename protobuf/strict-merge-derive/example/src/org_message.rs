...
pub struct Compound {
    ...
    pub vec_enum_default: ::std::vec::Vec<::protobuf::ProtobufEnumOrUnknown<AnEnum>>,
...
impl ::protobuf::Message for Compound {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                24 => {
                    ::protobuf::rt::read_repeated_enum_or_unknown_into(wire_type, is, &mut self.vec_enum_default)?
                },
                25 => {
                    ::protobuf::rt::read_repeated_enum_or_unknown_into(wire_type, is, &mut self.vec_enum_o_empty)?
                },
                26 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.bool_true = is.read_bool()?;
                },
                27 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.bytes_o_empty.is_empty() {
            my_size += ::protobuf::rt::bytes_size(19, &self.bytes_o_empty);
        }
        ...
        for value in &self.vec_enum_default {
            my_size += ::protobuf::rt::enum_or_unknown_size(24, *value);
        };
        for value in &self.vec_enum_o_empty {
            my_size += ::protobuf::rt::enum_or_unknown_size(25, *value);
        };
        if self.bool_true != false {
            my_size += 3;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.bytes_o_empty.is_empty() {
            os.write_bytes(19, &self.bytes_o_empty)?;
        }
        ...
        for v in &self.vec_enum_default {
            os.write_enum(24, ::protobuf::ProtobufEnumOrUnknown::value(v))?;
        };
        for v in &self.vec_enum_o_empty {
            os.write_enum(25, ::protobuf::ProtobufEnumOrUnknown::value(v))?;
        };
        if self.bool_true != false {
            os.write_bool(26, self.bool_true)?;
        }
        if self.bool_false != false {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::rt::make_vec_accessor::<_, ::protobuf::reflect::types::ProtobufTypeEnumOrUnknown<AnEnum>>(
                "vec_enum_default",
                |m: &Compound| { &m.vec_enum_default },
                |m: &mut Compound| { &mut m.vec_enum_default },
            ));
            fields.push(::protobuf::reflect::rt::make_vec_accessor::<_, ::protobuf::reflect::types::ProtobufTypeEnumOrUnknown<AnEnum>>(
                "vec_enum_o_empty",
                |m: &Compound| { &m.vec_enum_o_empty },
                |m: &mut Compound| { &mut m.vec_enum_o_empty },
            ));
            fields.push(::protobuf::reflect::rt::make_simple_field_accessor::<_, ::protobuf::reflect::types::ProtobufTypeBool>(
                "bool_true",
                |m: &Compound| { &m.bool_true },
                |m: &mut Compound| { &mut m.bool_true },
            ));
            fields.push(::protobuf::reflect::rt::make_simple_field_accessor::<_, ::protobuf::reflect::types::ProtobufTypeBool>(
                "bool_false",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\"\n\rbytes_o_empty\x18\x13\x20\x01(\x0cR\x0bbytesOEmpty\x12,\n\x12v\
    ec_double_default\x18\x14\x20\x03(\x01R\x10vecDoubleDefault\x12+\n\x12ve\
    c_double_o_empty\x18\x15\x20\x03(\x01R\x0fvecDoubleOEmpty\x12F\n\x13vec_\
    message_default\x18\x16\x20\x03(\x0b2\x16.benji.infra.req.InnerR\x11vecM\
    essageDefault\x12E\n\x13vec_message_o_empty\x18\x17\x20\x03(\x0b2\x16.be\
    nji.infra.req.InnerR\x10vecMessageOEmpty\x12A\n\x10vec_enum_default\x18\
